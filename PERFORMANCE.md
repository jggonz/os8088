...
fixed — read Set 30 before quoting the old ratio.** MartyPC models instruction
...
an interleave and a data rate (Set 30, docs/MARTYPC-DEBUG.md), and on the IBM
...
### Set 30 — MartyPC's floppy is given a platter
...
Set 30 shipped saying MartyPC "will still not catch a disk CORRECTNESS bug".
...
#### Set 30.1 — the seek and the spin-up get an instrument
