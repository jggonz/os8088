...
#
# Build the C toolchain's capability gate (SPEC.md 67) end to end and put it on
...
#     the C that is silently wrong here - &automatic above all (SPEC.md 67.5).
...
#     (67.8). Never pass --quiet or --no-gate here.
