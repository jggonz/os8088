...
SOAK = [
    ...
    Row("paccman", "soak", py("tests/paccman.py"), 100.0,
        ...
        "chain, and the water mark in the worker's own slice (178 of 256 on "
        "both profiles) is the only thing that says the interrupt floor on "
        "top of it fits. SOAK and not "
