...
SOAK = [
    ...
    Row("telzm", "soak", py("tests/telzm.py"), 300.0,
        ...
        "tiny files, each Save dialog ANSWERED with Return and [tz_name] read "
        ...
        "code - and the twelve names asserted again as DIRECTORY ENTRIES in "
        "MEDIA/, which is where SPEC.md 38.10 opens a Save dialog for an "
        "application that has chosen nowhere. Then one file under 4KB (one "
