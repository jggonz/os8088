...
;
; The assembly shim of RUNCPM, RunCPM 6.9 reimplemented in C (SPEC.md 71) -
...
; The hand-written half (SPEC.md 70.11's rule that the inner loop is assembly):
...
%include "runcpm/rcband.inc"        ; the row composer and the row compare -
                                    ; ONE drawing call per changed row (71.2)
