 ...
 * ---------------------------------------------------------------------------
 * `nasm -f bin` has no notion of an external symbol (SPEC.md 67.1), so a C
 ...
 * pointing it at an automatic is refused at build time - SPEC.md 67.5), and
 ...
 *
 * APP_MAX_SIZE is 61,440 bytes for image and bss TOGETHER (SPEC.md 67.9), and
 ...
 * real chain and assembling the result under SPEC.md 67.2's four section
 ...
 * is paid for twice, once on the floppy and once in the region (SPEC.md 67.9 -
