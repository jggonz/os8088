...
PERFORMANCE.md Set 28 is what this file exists to prevent a second time: two
candidates were *named* in Set 27 and had to be fully built to be judged. The
...
Everything Set 28 needed already exists in the tree:
...
- **The A/B recipe** is a bootable 360KB disk per kernel:
  ...
  and the pixel gate reports it as a defect (it is not — PERFORMANCE.md Set 27).
