...
| theme | bytes | share |
|---|---:|---:|
| the file system, end to end | 28,581 | 36.6% |
| the window system and its furniture | 16,274 | 20.8% |
...
|---|---:|---:|---:|---:|---:|
| `files.inc` — the Disk window (§22) | 917 | 7,251 | **8,168** | 336 | — |
...
| **total** | **55,329** | **22,797** | **78,126** | **4,751** | **7,762** |
<!-- END generated table -->
