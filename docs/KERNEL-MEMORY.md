...
| theme | bytes | share |
|---|---:|---:|
| the file system, end to end | 28,544 | 36.6% |
...
| the kernel proper: API table, heap, scheduler, events | 5,934 | 7.6% |
...
| `kernel.asm` — API table, entry points, `kmain`, the shims | 2,742 | — | **2,742** | — | — |
| **total** | **55,256** | **22,760** | **78,016** | **4,751** | **7,762** |
<!-- END generated table -->
