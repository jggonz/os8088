...
| theme | bytes | share |
|---|---:|---:|
| the file system, end to end | 26,686 | 36.8% |
...
| the kernel proper: API table, heap, scheduler, events | 5,628 | 7.8% |
...
| `assoc.inc` — file type associations (§54) | 2,818 | — | **2,818** | 43 | — |
...
| **total** | **50,649** | **21,841** | **72,490** | **4,058** | **7,748** |
<!-- END generated table -->
