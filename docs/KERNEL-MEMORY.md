...
| theme | bytes | share |
|---|---:|---:|
| the file system, end to end | 30,216 | 36.1% |
| the window system and its furniture | 18,926 | 22.6% |
| drawing: adapters, primitives, glyphs, icons | 12,628 | 15.1% |
| hardware: drivers, clock, mouse, sound, CPU, XMS | 10,008 | 12.0% |
| the kernel proper: API table, heap, scheduler, events | 6,701 | 8.0% |
| the Control Panel | 3,876 | 4.6% |
| the three built-in kinds | 1,365 | 1.6% |
| **total** | **83,720** | |
<!-- /kernsize:themes -->
...
| `disk.inc` — volumes, mount, the FAT read path (§18–19) | 352 | 5,597 | **5,949** | 885 | 3,584 |
...
| `assoc.inc` — file type associations (§54) | 517 | 2,352 | **2,869** | 43 | — |
| `driver.inc` — loadable drivers + `SYSTEM.CFG` (§51) | 405 | 2,371 | **2,776** | 341 | — |
...
| `kernel.asm` — API table, entry points, `kmain`, the shims | 3,447 | — | **3,447** | — | — |
| **total** | **47,134** | **36,586** | **83,720** | **5,704** | **7,762** |
<!-- END generated table -->
