...
| the window system and its furniture | 19,365 | 23.9% |
...
| `wm.inc` — the window manager (§11) | 8,424 | — | **8,424** | 765 | — |
...
| `ui.inc` — the UI task and the event ladder (§13) | 2,645 | — | **2,645** | 40 | — |
...
| **total** | **46,840** | **34,269** | **81,109** | **5,746** | **7,762** |
<!-- END generated table -->
