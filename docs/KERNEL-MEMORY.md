...
| theme | bytes | share |
|---|---:|---:|
| the file system, end to end | 28,645 | 37.0% |
...
| the kernel proper: API table, heap, scheduler, events | 5,894 | 7.6% |
...
| `kernel.asm` — API table, entry points, `kmain`, the shims | 2,702 | — | **2,702** | — | — |
| **total** | **54,920** | **22,442** | **77,362** | **4,736** | **7,762** |
<!-- END generated table -->
...
**The number to watch is NOT the 1,544 spare, it is the IMAGE's last sector.**
