...
> **Stage 3 — the socket half — has moved to docs/plans/completed/NET-STACK-PLAN.md**, which
...
> docs/plans/completed/BROWSER-PLAN.md. §1–§4 and §6–§9 here are unchanged and still describe
...
with nibble and DirectParallel modes (docs/plans/completed/DEBUG-PLAN.md §1.1 surveyed them),
