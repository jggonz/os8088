...
it converges. This is docs/plans/completed/HDD-SPLIT-PLAN.md §4.1's severance, automated.
...
docs/plans/completed/HDD-SPLIT-PLAN.md §10 had to report the peak 3 KB *worse*, because the
...
docs/plans/completed/HDD-SPLIT-PLAN.md §10 sprang this twice in one build: the verb was passed
...
docs/plans/completed/HDD-SPLIT-PLAN.md §6.1 exactly. The Control Panel's window dispatches
...
4. **`.DRV`, or a new extension?** `.DRV` buys the attributes, the copy rule
   ...
   driver being called one — docs/plans/completed/HDD-SPLIT-PLAN.md's decision 4, unresolved
