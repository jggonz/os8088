...
It is what makes Tier 3 (`docs/plans/completed/WMEVENT-PLAN.md`) worth having: a package with a
...
harder.** docs/plans/completed/MOUSEUP-PLAN.md §7 refused a pressed state because a static one
