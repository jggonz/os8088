...
| §27.13 | the row index — a row outside the view without walking to it | content pixel-identical to a full repaint in 3 of 4 states; the 4th is docs/NOTEPAD-NOTES.md §5.2.1 and predates the work |
...
Latent, documented at docs/NOTEPAD-NOTES.md §5.3.1. `np_rows` is 60 words; the walk's natural-end
